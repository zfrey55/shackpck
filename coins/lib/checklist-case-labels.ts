...
const CANONICAL_LABELS: Record<string, { short: string; long: string }> = {
  ...
  '67': { short: 'ShackPack 67', long: LONG },
  ...
  'full-squeeze': { short: 'Juicebox Bullion Full Squeeze', long: LONG },
  'single-squeeze': { short: 'Juicebox Bullion Single Squeeze', long: LONG },
  'double-squeeze': { short: 'Juicebox Bullion Double Squeeze', long: LONG },
