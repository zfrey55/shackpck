...
2. **Generate test labels:**
   - Place a test order through the normal checkout flow; the label is
     generated by `/api/orders`. (The `/test` dashboard that used to do this
     was removed — it was a public, unauthenticated debug page.)
   - Select **ZPLII** format
